...
QUERY_PARSER_PROMPT = """당신은 3D 프린팅 전문가입니다.
...
EVALUATOR_PROMPT = """당신은 연구 품질 평가자입니다.
...
SYNTHESIZER_PROMPT = """당신은 3D 프린팅 전문가입니다.
...
REFINER_PROMPT = """이전 검색 결과가 불충분합니다.
...
FINAL_RESPONSE_TEMPLATE = """## 문제 분석

{synthesis}

## 추천 파라미터 (전체 신뢰도: {confidence:.0%})
